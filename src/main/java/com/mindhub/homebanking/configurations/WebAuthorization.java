...
public class WebAuthorization{
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.PUT, "/api/clients/current/cards/{id}/hide").hasAuthority("CLIENT")
                .antMatchers(HttpMethod.GET, "/api/**").hasAnyAuthority("ADMIN")
                .antMatchers(HttpMethod.GET, "/api/transactions/account/{account_id}").hasAuthority("CLIENT")
                .antMatchers(HttpMethod.GET, "application/pdf").hasAuthority("CLIENT")
        .antMatchers(HttpMethod.GET, "/api/clients/current',{headers:{'accept':'application/xml'}}").hasAuthority("CLIENT)")
        .antMatchers(HttpMethod.GET, "/api/clients/current/accounts/current/transactions").hasAuthority("CLIENT")
        .antMatchers(HttpMethod.POST, "/api/clients/current/accounts/current/transactions").hasAuthority("CLIENT")
                        .antMatchers(HttpMethod.PATCH,"api/clients/current/accounts/{id}/hide").hasAuthority("CLIENT")
        .antMatchers(HttpMethod.PATCH, "/api/clients/current/accounts/delete/**").hasAuthority("CLIENT");
