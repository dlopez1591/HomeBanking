...
createApp({
    ...
    methods: {
        ...
        newLoan:function(){
            console.log(this.accountDestiny, "y")
            console.log(this.accountDestini, "i")
            axios.post("/api/loans",{"id":this.id,"amount":this.amount,"payments":this.payments,"accountDestiny":this.accountDestiny})
        .then(response=>{
