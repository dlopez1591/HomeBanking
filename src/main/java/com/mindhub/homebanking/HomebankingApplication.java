...
//		return (args) -> {
//			//Creacion object
//			Client client=new Client("Melba", "Morel","melba@mindhub.com",passwordEncoder.encode("melba123"));
//			Client client2=new Client("Daniel", "Lopez","dlopez1591@gmail.com",passwordEncoder.encode("daniel123"));
...
//			ClientLoan pres2=new ClientLoan( 50000, 12, client2, loan2);
//			ClientLoan pres3=new ClientLoan( 100000, 24, client, loan3 );
//			ClientLoan pres4=new ClientLoan(  200000, 36, client, loan1);
//
