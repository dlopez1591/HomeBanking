...
public class Utilitis {
    ...
    //tiliza para verificar si el número de cuenta generado ya existe en la base de datos
    ...
    //genera un número de 8 dígitos aleatorio que se utiliza para generar el número de cuenta.
    ...
    public static void generateRandomTransactions(Account account, int cant){
        ...
        for (int i=0;i<cant;i++){
            ...
            Transaction trans = new Transaction(type,amount,description, LocalDateTime.now(),0.0);
